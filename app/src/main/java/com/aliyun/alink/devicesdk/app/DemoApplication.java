...
//        ALog.setLogUpload(new com.aliyun.alink.linksdk.LogUploader());
    ...
    public void initBreeze(boolean debug){
        Config config = new Config.Builder()
                .debug(debug)
                .log(true)
                .logLevel(debug ? com.aliyun.iot.ble.util.Log.VERBOSE : com.aliyun.iot.ble.util.Log.WARN)
                .build();
        BREEZE = Factory.createBreeze(this);
        BREEZE.configure(config);

//        com.aliyun.iot.ble.Config.DEBUG_SENT_RCVD = true;
        Breeze.NETWORK_ENV = Breeze.NETWORK_ENV_TANWAI_MQTT;
    }
